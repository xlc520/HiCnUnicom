...
# 安卓手机端APP登录过的使用这个UA
UA="Mozilla/5.0 (Linux; Android 10; Redmi K30 5G Build/QKQ1.191222.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.4103.101 Mobile Safari/537.36; unicom{version:android@8.0100,desmobile:$username};devicetype{deviceBrand:Xiaomi,deviceModel:Redmi K30 5G};{yw_code:}"
